...
> 产品目标、实现细节、Dify 工作流、API 契约与部署见 **[docs/design.md](./docs/design.md)**；**EdgeOne / Dify 已用功能清单**见 **[docs/edgeone-dify-features.md](./docs/edgeone-dify-features.md)**。
...
│   ├── edgeone-dify-features.md   # EdgeOne / Dify 已用能力说明
│   ├── script.md                  # 参赛视频脚本
│   └── test-cases.md              # 测试用例
