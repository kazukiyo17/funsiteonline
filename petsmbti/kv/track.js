/**
 * POST /api/petsmbti/complete — 服务端实现（路由：functions/api/petsmbti/complete.js）
 */

import { incr, jsonHeaders, readJson, getKvBinding, corsOptionsPost } from "../../quiz-kv/quizKvCore.js";

export { corsOptionsPost };

var BINDING = "petsmbti_quiz_kv";
...
export async function runPetsmbtiComplete(context, bodyParsed) {
  var kv = getKvBinding(context.env, BINDING);
  if (!kv) {
